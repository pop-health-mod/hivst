...
# ---testing code for incorporating diffrent rate ratios by age to the final model----
rm(list = ls())
gc()
...
saveRDS(hivst_stan, "Model results/hivst_stan_model_apr14.rds")
hivst_stan <- readRDS("Model results/hivst_stan_model_apr14.rds")

...
# ----- changing the standard error for programmatic HIVST distribution data to 5% ----
rm(list = ls())
gc()
...
cnt_data <- list(
  kenya = list(
    ...
    se_hts = c(197200, 400000, 595953, 630000, 342610, 617317) * 0.05
  ),
  ...
  ghana = list(
    ...
    se_hts = c(20000, 1323, 235000, 140500) * 0.05
  ),
  malawi = list(
    ...
    se_hts =  c(408900, 101256, 561282, 602657, 735385, 910088) * 0.05
  ),
  madagascar = list(
  ...
  zimbabwe = list(
    ...
    se_hts = c(197408, 174566, 240434, 459517, 414499, 513090) * 0.05
  ),
  ...
  zambia = list(
    ...
    se_hts = c(315348, 781175, 639225, 23750, 33153, 95559) * 0.05
  ),
  mali = list(
    yr_svy =  2018.5,
    ind_svy = (2018.5 - start) / dt,
    ...
    se_hts = c(7763, 169962, 11375, 235729) * 0.05
  ),
  uganda = list(
    yr_svy =  2016.5,
    ...
    se_hts = c(42570, 306421, 750698, 681602) * 0.05
  ),
  lesotho  = list(
    ...
    se_hts = c(58917, 42650, 164236, 281277, 301762, 262915) * 0.05
  ),
  mozambique = list(
    ...
    se_hts = c(67883, 203966, 683345) * 0.05
  ),
  rwanda = list(
    yr_svy =  2019.5,
  ...
  cotedivoire = list(
    ...
    se_hts = c(1159, 111184, 117556, 41774, 60154) * 0.05
  ),
  guinea = list(
    yr_svy =  2018.5,
    ind_svy = (2018.5 - start) / dt,
  ...
  senegal = list(
    ...
    se_hts = c(7307, 18860, 5505, 4056, 11932) * 0.05
  ),
  southafrica = list(
    yr_svy =  2016.5,
    ind_svy = (2016.5 - start) / dt,
    ...
    se_hts = c(1200000, 794034, 913418, 212000) * 0.05
  ),
  tanzania = list(
    yr_svy =  2022.5,
    ...
    se_hts = c(25810, 14940, 19000, 38717, 809603, 1447029) * 0.05
  ),
  ...
  namibia = list(
    ...
    se_hts = c(3910, 40075, 47258, 130000, 27974) * 0.05
  ),
  ...
  botswana = list(
    ...
    se_hts = c(7000, 3848, 8403, 16405) * 0.05
  ),
  ...
  eswatini = list(
    ...
    se_hts = c(33159, 32531, 191990, 78570, 111912) * 0.05
  ),
...
traceplot(fit, pars = "beta_male_raw")d
...
saveRDS(fit, file = "hivst_stan_fit_sepgm5.rds") 
fit <- readRDS("hivst_stan_fit_sepgm5.rds") 


#---------------------------------------------------------------------------------------------

# ----- changing the standard error for programmatic HIVST distribution data to 15% ----
rm(list = ls())
gc()
...
cnt_data <- list(
  kenya = list(
    ...
    ind_hts = (c(2018, 2019, 2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(197200, 400000, 595953, 630000, 342610, 617317),
    se_hts = c(197200, 400000, 595953, 630000, 342610, 617317) * 0.15
  ),
  ...
  ghana = list(
    ...
    ind_hts = (c(2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(20000, 1323, 235000, 140500),
    se_hts = c(20000, 1323, 235000, 140500) * 0.15
  ),
  malawi = list(
    yr_svy = c(2015.5, 2019.5, 2020.5),
    ind_svy = (c(2015.5, 2019.5, 2020.5) - start) / dt,
    ...
    ind_hts = (c(2018, 2019, 2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(408900, 101256, 561282, 602657, 735385, 910088),
    se_hts =  c(408900, 101256, 561282, 602657, 735385, 910088) * 0.15
  ),
  madagascar = list(
    yr_svy = c(2018.5, 2021.5),
    ind_svy = (c(2018.5, 2021.5) - start) / dt,
  ...
  zimbabwe = list(
    ...
    ind_hts = (c(2018, 2019, 2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(197408, 174566, 240434, 459517, 414499, 513090),
    se_hts = c(197408, 174566, 240434, 459517, 414499, 513090) * 0.15
  ),
  ...
  zambia = list(
    ...
    ind_hts = (c(2018, 2019, 2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(315348, 781175, 639225, 23750, 33153, 95559),
    se_hts = c(315348, 781175, 639225, 23750, 33153, 95559) * 0.15
  ),
  mali = list(
    yr_svy =  2018.5,
    ind_svy = (2018.5 - start) / dt,
    ...
    ind_hts = (c(2019, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(7763, 169962, 11375, 235729),
    se_hts = c(7763, 169962, 11375, 235729) * 0.15
  ),
  uganda = list(
    yr_svy =  2016.5,
    ind_svy = (2016.5 - start) / dt,
    ...
    ind_hts = (c(2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(42570, 306421, 750698, 681602),
    se_hts = c(42570, 306421, 750698, 681602) * 0.15
  ),
  lesotho  = list(
    yr_svy =  c(2020.5, 2023.5),
    ind_svy = (c(2020.5, 2023.5) - start) / dt,
    ...
    ind_hts = (c(2018, 2019, 2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(58917, 42650, 164236, 281277, 301762, 262915),
    se_hts = c(58917, 42650, 164236, 281277, 301762, 262915) * 0.15
  ),
  mozambique = list(
    yr_svy =  c(2021.5, 2022.5),
    ind_svy = (c(2021.5, 2022.5) - start) / dt,
    ...
    ind_hts = (c(2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(67883, 203966, 683345),
    se_hts = c(67883, 203966, 683345) * 0.15
  ),
  rwanda = list(
    yr_svy =  2019.5,
    ind_svy = (2019.5 - start) / dt,
  ...
  cotedivoire = list(
    ...
    ind_hts = (c(2018, 2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(1159, 111184, 117556, 41774, 60154),
    se_hts = c(1159, 111184, 117556, 41774, 60154) * 0.15
  ),
  guinea = list(
    yr_svy =  2018.5,
    ind_svy = (2018.5 - start) / dt,
  ...
  senegal = list(
    ...
    ind_hts = (c(2019, 2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(7307, 18860, 5505, 4056, 11932),
    se_hts = c(7307, 18860, 5505, 4056, 11932) * 0.15
  ),
  southafrica = list(
    yr_svy =  2016.5,
    ind_svy = (2016.5 - start) / dt,
    ...
    ind_hts = (c(2018, 2019, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(1200000, 794034, 913418, 212000),
    se_hts = c(1200000, 794034, 913418, 212000) * 0.15
  ),
  tanzania = list(
    yr_svy =  2022.5,
    ind_svy = (2022.5 - start) / dt,
    ...
    ind_hts = (c(2018, 2019, 2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(25810, 14940, 19000, 38717, 809603, 1447029),
    se_hts = c(25810, 14940, 19000, 38717, 809603, 1447029) * 0.15
  ),
  ...
  namibia = list(
    ...
    ind_hts = (c(2018, 2020, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(3910, 40075, 47258, 130000, 27974),
    se_hts = c(3910, 40075, 47258, 130000, 27974) * 0.15
  ),
  ...
  botswana = list(
    ...
    ind_hts = (c(2019, 2021, 2022, 2023) - start + 0.5) / dt,
    hts_dat = c(7000, 3848, 8403, 16405),
    se_hts = c(7000, 3848, 8403, 16405) * 0.15
  ),
  ...
  eswatini = list(
    ...
    ind_hts = (c(2018, 2019, 2020, 2021, 2022) - start + 0.5) / dt,
    hts_dat = c(33159, 32531, 191990, 78570, 111912),
    se_hts = c(33159, 32531, 191990, 78570, 111912) * 0.15
  ),
...
saveRDS(fit, file = "hivst_stan_fit_sepgm15.rds") 
fit <- readRDS("hivst_stan_fit_sepgm15.rds") 
